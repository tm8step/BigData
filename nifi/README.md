...
The HDFS screenshot shows the `hdfs dfs -ls` output confirming that the project dataset was successfully written into HDFS in /data/WiscBreastCancerData.csv.  It also shows the beginning of the data in the file, confirming the correct data was loaded.
